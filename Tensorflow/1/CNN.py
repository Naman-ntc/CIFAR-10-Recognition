...
def test_output():
	...
	W2 = tf.Variable(tf.random_normal([4,4,84,42]))
	W5 = tf.Variable(tf.random_normal([5,5,42,16]))
	...
	temp6 = tf.nn.conv2d(temp6,W5,strides=[1, 1, 1, 1],padding='VALID')
	D = temp6.shape
	B5 = tf.Variable(tf.random_normal(D[1:]))
	temp6 = tf.add(temp6,B5)
	D = temp6.shape
	D = D[1]*D[2]*D[3]
